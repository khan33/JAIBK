...
import Foundation
enum WishlistRequestModel {
    class AddWishlistRequest : RequestModel {
        ...
        init(first_name: String, last_name: String, street_address: String, country: String, city: String, phone_no: String, session_id: String) {
